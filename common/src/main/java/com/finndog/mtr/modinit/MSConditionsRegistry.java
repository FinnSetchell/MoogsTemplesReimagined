...
import com.finndog.mtr.modinit.registry.CustomRegistry;
...
public final class MSConditionsRegistry {
    ...
    public static final ResourceKey<Registry<Supplier<Boolean>>> MVS_JSON_CONDITIONS_KEY = ResourceKey.createRegistryKey(new ResourceLocation(MSCommon.MODID, "json_conditions"));
    public static final CustomRegistry<Supplier<Boolean>> MVS_JSON_CONDITIONS_REGISTRY = CustomRegistry.of(MSCommon.MODID, MVS_JSON_CONDITIONS_KEY, false, false, true);
