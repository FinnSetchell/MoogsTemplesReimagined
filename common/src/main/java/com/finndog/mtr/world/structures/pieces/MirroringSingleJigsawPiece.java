...
public class MirroringSingleJigsawPiece extends SinglePoolElement {
    ...
    public MirroringSingleJigsawPiece(SinglePoolElement singleJigsawPiece, Mirror mirror) {
        this(((SinglePoolElementAccessor)singleJigsawPiece).ms_getTemplate(), ((SinglePoolElementAccessor)singleJigsawPiece).ms_getProcessors(), singleJigsawPiece.getProjection(), mirror);
    }
